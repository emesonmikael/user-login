...
const M3UPlayerAMConDemand = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/AMConDemand.m3u'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerAMConDemand;
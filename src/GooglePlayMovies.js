...
const M3UPlayerGooglePlayMovies = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/GooglePlayMovies.m3u'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerGooglePlayMovies;
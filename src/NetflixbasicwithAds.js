...
const M3UPlayerNetflixbasicwithAds = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/NetflixbasicwithAds.m3u'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerNetflixbasicwithAds;
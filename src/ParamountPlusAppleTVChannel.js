...
const M3UPlayerParamountPlusAppleTVChannel = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/ParamountPlusAppleTVChannel.m3u'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerParamountPlusAppleTVChannel;
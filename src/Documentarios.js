...
const M3UPlayerDocumentarios = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/Documentarios.m3u'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerDocumentarios;